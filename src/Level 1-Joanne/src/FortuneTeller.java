...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	FortuneTeller() throws Exception {
		...
		// package
		fortuneTellerImage = ImageIO.read(getClass().getResource("Fortune_Telling_Cat.jpg"));
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Welcome. Click on the part of the cat with a collar.");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			JOptionPane.showInputDialog("Ask a question for the fortune teller.");
